...
std::list<Token> Lexer::lex_l(const std::string &from) noexcept
{
    pos = 0;
    line = 1;
    text = from;
...
std::vector<Token> Lexer::lex_v(const std::string &What,
...
bool Token::is_suit_open(const Token &_what)
{
    return _what == "$[";
}

bool Token::is_negated_suit_open(const Token &_what)
{
    return _what == "$[^";
}

bool Token::is_suit_close(const Token &_what)
{
    return _what == "$]";
}

bool Token::is_subexpr_open(const Token &_what)
{
    return _what == "$(";
}

bool Token::is_subexpr_close(const Token &_what)
{
    return _what == "$)";
}

bool Token::is_disjunction(const Token &_what)
{
    return _what == "$|";
}

bool Token::is_wildcard(const Token &_what)
{
    return _what == "$.";
}

bool Token::is_optional(const Token &_what)
{
    return _what == "$?";
}

bool Token::is_star(const Token &_what)
{
    return _what == "$*";
}

bool Token::is_plus(const Token &_what)
{
    return _what == "$+";
}

bool Token::is_mem_clear(const Token &_what)
{
    return _what == "$~";
}

bool Token::is_mem_pipe(const Token &_what)
{
    return _what.substr(0, 2) == "$>";
}
...
bool Token::is_epsilon(const Token &_what)
{
    return _what == "";
}

bool Token::is_escape(const Token &_what)
{
    return _what == "$$";
}
